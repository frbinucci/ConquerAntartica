 ...
 * @author franc
 */
public class Level3AlliedModel extends IceBlockTerrainModel {

    public Level3AlliedModel(double startXPosition, double startYPosition) {
    ...
    public void setPattern() {
        ...
        pattern.add(new Rectangle(startXPosition+150,
                ...
                Constants.BLOCK_DIMENSION,
                Constants.BLOCK_DIMENSION));
        pattern.add(new Rectangle(startXPosition,startYPosition-50,
                Constants.BLOCK_DIMENSION,
                Constants.BLOCK_DIMENSION));
        pattern.add(new Rectangle(startXPosition+100,
                startYPosition-50,
